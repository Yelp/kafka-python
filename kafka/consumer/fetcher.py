...
class Fetcher(six.Iterator):
    ...
    # TODO: manpreet check in the end if this is used?
    ...
    def _append(self, drained, part, max_records):
        ...
        if not self._subscriptions.is_assigned(tp):
            ...
            # TODO: manpreet: merge kafka-python/commit/7703b1a48d1a892388ae98e293cc377e3c22b2d9
        ...
        try:
            for offset, size, msg in messages:
                ...
                if not msg.is_compressed():
                    ...
                    # TODO: consider keeping this? manpreet
